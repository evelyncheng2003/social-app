...
function ViewAllPosts() {
    ...
    const showOverlayPost = (post_obj) => {
        console.log('post_obj.postID is: ' + post_obj.postId);
        ...
        //console.log('*** overlayId is: ' + overlayId);
    ...
    if (!click) {
        return (
            <div>
                <div class="cards-list">
                    {allPosts.map(((item) => (
                        <div class="card" onClick={showOverlayPost.bind(this, item)}>
        ...
        console.log('postId is : ' + overlayId);
        return (
            <div>
                <Overlay
                    overlayId={overlayId}
